...
namespace Banking_management_system.Controllers
{
    public class OperatorsController : Controller
    {
        ...
        public OperatorsController(Banking_management_systemContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BankName,Id,Name,Surname,Patronic,Email,Password,PasswordSeries,Phone,PasswordNumber")] Operator @operator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BankName,Id,Name,Surname,Patronic,Email,Password,PasswordSeries,Phone,PasswordNumber")] Operator @operator)
        {
            if (id != @operator.ID)
            {
                return NotFound();
