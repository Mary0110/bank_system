...
namespace Banking_management_system.Controllers
{
    public class BanksController : Controller
    {
        ...
        public BanksController(Banking_management_systemContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BIC,ID,Name,Percentage")] Bank bank)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BIC,ID,Name,Percentage")] Bank bank)
        {
            if (id != bank.ID)
            {
                return NotFound();
